          ...
          <AnimatePresence>
            {justAdded && (
              <motion.div
                ...
                className="absolute inset-0 z-50 bg-teal-500/20 backdrop-blur-sm flex items-center justify-center rounded-t-[20px] md:rounded-t-2xl"
              >
                <div className="flex items-center gap-2 bg-teal-500 text-black px-4 py-2 rounded-full font-bold text-sm shadow-xl">
