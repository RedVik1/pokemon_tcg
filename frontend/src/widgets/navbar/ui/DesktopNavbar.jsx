 ...
 * Shown only on md+ screens. Provides: branding, tab switching, search, user info, logout.
 */
      ...
      <div className="max-w-[1600px] mx-auto px-8 h-16 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-8 text-sm font-semibold">
          <button
            ...
            className={activeTab === "explore" ? "text-teal-400" : "text-slate-400 hover:text-white transition-colors"}
          >
            Explore
          </button>
          <button
            onClick={() => setActiveTab("portfolio")}
            className={activeTab === "portfolio" ? "text-teal-400" : "text-slate-400 hover:text-white transition-colors"}
          >
            Portfolio
          </button>
        </nav>
        <div className="flex items-center gap-4">
          <button onClick={onOpenPalette} className="p-2 text-slate-400 hover:text-white transition-colors">
            <Search size={20} />
          </button>
          ...
          <div className="flex items-center gap-2 text-slate-400 text-sm border-l border-white/10 pl-4 ml-2">
